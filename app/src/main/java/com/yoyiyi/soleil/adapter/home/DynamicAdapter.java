        ...
        switch (holder.getItemViewType()) {
                ...
                switch (itemBean.type) {
                    case 0://关注up
                        holder.setVisible(R.id.iv_avatar, true)
                                ...
                                .setText(R.id.tv_title_time,
                                        TimeUtils.getFriendlyTimeSpanByNow((long) (itemBean.ctime * Math.pow(10, 3))))
                    ...
                    case 2://国产动画
                        holder.setVisible(R.id.iv_avatar, false)
                                ...
                                .setText(R.id.tv_title_tag_time, TimeUtils.getFriendlyTimeSpanByNow((long) (itemBean.ctime * Math.pow(10, 3))))
            ...
            case MulDynamic.TYPE_LV1:
                ...
                holder.setVisible(R.id.iv_avatar, true)
                        ...
                        .setText(R.id.tv_title_time, TimeUtils.getFriendlyTimeSpanByNow((long) (recent.ctime * Math.pow(10, 3))))
